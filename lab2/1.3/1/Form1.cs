        ...
        private void CreateRandomButton_Click(object sender, EventArgs e)
        {
            switch (check)
            {
                ...
                case 2:
                    try
                    {
                        boxes.Add(new Box(picture));
                        DataObjects.Items.Add(boxes[boxIndex]);//DataObjects.Items.Add("Прямоугольник " + boxIndex);
                        boxIndex++;
                    }
                    catch
                    {
                ...
                case 3:
                    try
                    {
                        circles.Add(new Circle(picture));
        ...
        private void CreateSetButton_Click(object sender, EventArgs e)
        {
            switch (check)
            {
                case 1:
                    try
                    {
                        lines.Add(new Line(Convert.ToInt32(X1coord.Text), Convert.ToInt32(Y1coord.Text), Convert.ToInt32(X2coord.Text), Convert.ToInt32(Y2coord.Text), picture));
                        DataObjects.Items.Add("Линия " + lineIndex);
                        lineIndex++;
                    }
                    catch
                ...
                case 2:
                    try
                    {
                        boxes.Add(new Box(Convert.ToInt32(X1coord.Text), Convert.ToInt32(Y1coord.Text), Convert.ToInt32(X2coord.Text), Convert.ToInt32(Y2coord.Text), picture));
                ...
                case 3:
                    try
                    {
                        circles.Add(new Circle(Convert.ToInt32(X1coord.Text), Convert.ToInt32(Y1coord.Text), Convert.ToInt32(Radius.Text), picture));
                        DataObjects.Items.Add("Круг " + circleIndex);
                        circleIndex++;
                    }
                    catch
