            ...
            if (count < n)
            {
                ...
                foreach (var a in array)
                {
                    ...
                    switch (rnd)
                    {
                        case 0:
                            {
                                array[count] = new Box(picture);
                                break;
                            }
                        case 1:
                            {
                                array[count] = new RectangleFigure(picture);
                                break;
                            }
                        case 2:
                            {
                                array[count] = new Romb(picture);
                                break;
                            }
                        case 3:
                            {
                                array[count] = new Line(picture);
                                break;
                            }
                        case 4:
                            {
                                array[count] = new Circle(picture);
                                break;
                            }
                        case 5:
                            {
                                array[count] = new Ellipse(picture);
                                break;
                            }
                    }
                    count++;
